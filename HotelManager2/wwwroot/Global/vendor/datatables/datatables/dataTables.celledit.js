...
function getInputHtml(currentColumnIndex, settings, oldValue) {
    var inputSetting, inputType, input, inputCss, confirmCss, cancelCss, confirmText, cancelText;
    ...
    switch (inputType) {
        ...
        case "list-confirm": // List w/ confirm
            ...
            input.html = input.html + "</select><br /><a href='javascript:void(0)' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this);'>" + settings.confirmText + "</a> <a href='javascript:void(0)' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>"+settings.cancelText+"</a> ";
            input.focus = false;
            break;
        ...
        case "datepicker-confirm":
            ...
            input.html = "<input id='ejbeatycelledit' type='text' name='date' class='datepick " + inputCss + "'   value='" + oldValue + "'></input><br /><a href='javascript:void(0)' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>" + settings.confirmText + "</a> <a href='javascript:void(0)' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>" + settings.cancelText + "</a>";
        ...
        case "text-confirm": // text input w/ confirm
            input.html = "<input id='ejbeatycelledit' class='" + inputCss + "' value='" + oldValue + "'></input><br /><a href='javascript:void(0)' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>" + settings.confirmText + "</a> <a href='javascript:void(0)' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>" + settings.cancelText + "</a> ";
            break;
